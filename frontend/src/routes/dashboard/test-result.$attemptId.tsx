        ...
        <div className="rounded-2xl bg-surface-container-lowest p-10 shark-shadow border border-outline-variant/40 mb-8">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 grid grid-cols-6 gap-4">
              <div className="text-center p-4 rounded-xl bg-surface-container-low col-span-2">
              ...
              <div className="text-center p-4 rounded-xl bg-surface-container-low col-span-2">
                <div className="text-2xl font-bold text-on-surface-variant">{unattemptedCount}</div>
                <div className="text-xs text-on-surface-variant mt-1">Not Attempted</div>
              </div>
              <div className="text-center p-4 rounded-xl bg-surface-container-low col-span-3">
                <div className="text-xl font-bold text-on-surface">{attempt.totalQuestions}</div>
                <div className="text-xs text-on-surface-variant mt-1">Total Questions</div>
              </div>
              <div className="text-center p-4 rounded-xl bg-surface-container-low col-span-3">
                <div className="text-xl font-bold text-accent">{formatTime(attempt.timeTaken)}</div>
